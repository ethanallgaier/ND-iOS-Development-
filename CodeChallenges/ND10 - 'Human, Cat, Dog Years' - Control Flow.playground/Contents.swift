...
func humanCatDogYears(humanYears: Int) -> (humanYears: Int, catYears: Int, dogYears: Int) {
    var catYears: Int
    var dogYears: Int
...
humanCatDogYears(humanYears: 3)
humanCatDogYears(humanYears: 9)
humanCatDogYears(humanYears: 20)
humanCatDogYears(humanYears: 1)
